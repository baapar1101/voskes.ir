...
// rendered through src/pages/en/blog/[slug].astro with set:html rather than
...
for (const file of files) {
	...
	const canonical = $('link[rel="canonical"]').attr('href') || `https://voskes.nl/en/blog/${slug}`;
	...
	const bodyHtml = $.html(body.length ? body : $('body > div.site #page').children().first());
