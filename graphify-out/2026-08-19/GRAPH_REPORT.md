...
## Corpus Check
- 275 files · ~11,596,878 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 694 nodes · 758 edges · 76 communities (58 shown, 18 thin omitted)
...
- complete-local-sunux-images.mjs
- available
- bodyDescription
- composition
- heading
...
### Community 61 - "complete-local-sunux-images.mjs"
Cohesion: 0.18
Nodes (9): download(), entries, failures, files, publicRoot, references, root, sourceRoot (+1 more)

### Community 74 - "localize-sunux-images.mjs"
Cohesion: 0.18
Nodes (10): download(), downloads, entries, failures, files, publicRoot, root, sourceRoot (+2 more)

## Knowledge Gaps
- **384 isolated node(s):** `$schema`, `type`, `type`, `type`, `type` (+379 more)
...
- **Why does `properties` connect `properties` to `composition`, `heading`, `jsonLd`, `ogTitle`, `$schema`, `required`, `sliderNextLabel`, `sliderPrevLabel`, `required`, `slug`, `analyticalComponents`, `properties`, `available`, `bodyDescription`?**
